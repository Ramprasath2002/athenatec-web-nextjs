...
export const caseStudyContent: CaseStudyType[] = [
  {
    ...
    description:
      "Our Medical device customer had an external system to get approval for Surgical Plans from the surgeon which had to be integrated to Opcenter in several Operations.â€‹",
    formType: "siemens",
  },
  {
  ...
  },
  {
    ...
    description:
      "Athena was involved with implementing enterprise integration with real time synchronization of the data between SAP and CM MES. Integration was achieved by IoT / equipment integration using OPC-UA, file driver protocols, and features achieved with parts movement and real time data insights. was able to carry out the customization on the material management, maintenance model, and material logistics model.â€‹",
    formType: "cmf",
  },
  {
    ...
    description:
      "Currently the client has implemented a home grown MES solution for their main factory. Athenaâ€™s scope is to conduct the CM MES product implementation to the latest version, implement additional customization, industry best practices, reports, and post deployment support.â€‹",
    formType: "cmf",
  },
  {
  ...
  },
  {
    ...
    description:
      "Currently the client has implemented a CM MES solution for one of the large factory. The scope is for Athena to provide the CM MES product upgrade to the latest version, implement additional customization, include industry best practices, reports, and post deployment support.â€‹",
    formType: "cmf",
  },
];
